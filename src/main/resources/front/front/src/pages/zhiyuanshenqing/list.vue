...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","margin":"40px 0 0","alignItems":"center","flexWrap":"wrap","textAlign":"center","background":"#f5f5f5","display":"flex","width":"100%","height":"auto"}'>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>团队名称</div>
        <el-input v-model="formSearch.tuanduimingcheng" placeholder="团队名称" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>用户名</div>
        <el-input v-model="formSearch.xingming" placeholder="用户名" clearable></el-input>
      </el-form-item>
	  ...
	  <el-button v-if="isAuth('zhiyuanshenqing','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 10px","margin":"0 10px 0 0","color":"#fff","minWidth":"90px","outline":"none","borderRadius":"0","background":"#9f9fd7","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/zhiyuanshenqingAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        let searchWhere = {};
        if (this.formSearch.tuanduimingcheng != '') searchWhere.tuanduimingcheng = '%' + this.formSearch.tuanduimingcheng + '%';
        if (this.formSearch.xingming != '') searchWhere.xingming = '%' + this.formSearch.xingming + '%';
	      params['sfsh'] = '是';
        this.$http.get('zhiyuanshenqing/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/zhiyuanshenqingDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
