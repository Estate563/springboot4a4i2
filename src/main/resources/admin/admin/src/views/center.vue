  ...
  <div :style='{"padding":"30px","background":"url(http://codegen.caihongy.cn/20230303/76c3e36e1fa546ef8e134d65e6665618.jpg) center bottom/cover no-repeat fixed","height":"calc(100vh - 120px)"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="用户名" prop="xingming">
          <el-input v-model="ruleForm.xingming"               placeholder="用户名" clearable></el-input>
        </el-form-item>
