<template>
	<div class="addEdit-block" :style='{"padding":"30px","background":"url(http://codegen.caihongy.cn/20230303/76c3e36e1fa546ef8e134d65e6665618.jpg) center bottom/cover no-repeat fixed","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="发布标题" prop="zhishibiaoti">
					<el-input v-model="ruleForm.zhishibiaoti" placeholder="发布标题" clearable  :readonly="ro.zhishibiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="发布标题" prop="zhishibiaoti">
					<el-input v-model="ruleForm.zhishibiaoti" placeholder="发布标题" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="发布类型" prop="zhishileixing">
					<el-select :disabled="ro.zhishileixing" v-model="ruleForm.zhishileixing" placeholder="请选择发布类型" >
						<el-option
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="发布类型" prop="zhishileixing">
					<el-input v-model="ruleForm.zhishileixing"
						placeholder="发布类型" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="发布人" prop="xingtaitezheng">
					<el-input v-model="ruleForm.xingtaitezheng" placeholder="发布人" clearable  :readonly="ro.xingtaitezheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="发布人" prop="xingtaitezheng">
					<el-input v-model="ruleForm.xingtaitezheng" placeholder="发布人" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="信息时效" prop="shenghuoxixing">
					<el-input v-model="ruleForm.shenghuoxixing" placeholder="信息时效" clearable  :readonly="ro.shenghuoxixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="信息时效" prop="shenghuoxixing">
					<el-input v-model="ruleForm.shenghuoxixing" placeholder="信息时效" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="审核人" prop="xunyangfangfa">
					<el-input
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.xunyangfangfa" label="审核人" prop="xunyangfangfa">
